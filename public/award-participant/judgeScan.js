...
function OnScoreButtonClicked(aScoreValue)
{
    ...
    let contract = await new web3.eth.contract(abi, master_add);

    contract.methods.transfer(team_hash_code, aScoreValue).send({
        from: "0x6545db83490771e067fe3bb344a1f2f4db36aab7"
    });
    CameraStatus(true);
    ScoreBoardState(false);
}
